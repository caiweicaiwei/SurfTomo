...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!PROGRAM tomo_surf
subroutine CalSurfG(nx,ny,nz,nparpi,vels,iw,rw,col,dsurf,obst, &
              ...
              nar,maxlevel,maxleveld,HorizonType,VerticalType)
USE globalp
USE traveltime
IMPLICIT NONE
...
!  
 ...
 count1=count1+1
dsurf(count1)=cbst1-obst(count1) 
!!-------------------------------------------------------------
!   ENDIF
!
